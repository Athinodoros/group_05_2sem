...
<html>
    ...
    <body>
        ...
        <ul class="nav nav-sidebar">
            ...
            <li><a href="#"><form action="UIServlet" method="POST"><input name="<%= NamingConv.MAINAREA %>" value="<%= NamingConv.VIEW_BUDGET %>"  hidden/><input name="command" value="reloadMain" hidden/><button class="MenuButtons" type="submit">View company budget</button></form></a></li>
